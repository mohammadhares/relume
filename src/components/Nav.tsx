...
const Nav: React.FC = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-[var(--gold-warm)]/30 bg-[var(--ink)]/70 backdrop-blur relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="hidden md:flex items-center h-20">
          ...
          <div className="flex-1 text-right">
            <button className="inline-flex items-center px-5 py-2.5 rounded-full bg-[var(--gold)] hover:bg-[var(--gold-bright)] text-sm font-semibold text-[var(--ink)] shadow-md shadow-black/30 transition-all duration-300 transform hover:scale-105 hover:shadow-lg cursor-pointer">
              Access
            </button>
          </div>
        </div>
